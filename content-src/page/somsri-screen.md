...
i18n:
  title:
    th: รับสกรีนเสื้อทุกชนิด สกรีนด่วน สกรีนโลโก้คมชัด ราคาโรงงาน | สมศรีมีเสื้อ
    en: Screen Printing for All Shirts — Express, Crisp Logos, Factory Prices |
      Somsri
  description:
    th: บริการรับสกรีนเสื้อยืด เสื้อทีม เสื้อกิจกรรม ด้วยระบบ DFT, Silk Screen,DTG
      และอื่นๆ สีสด ทนนาน ไม่หลุดลอก ออกแบบฟรี ขั้นต่ำน้อย งานด่วนสั่งได้
      พร้อมจัดส่งทั่วประเทศ
    en: Screen printing for tees, team and activity shirts using DFT, silk screen,
      DTG and more — vivid, long-lasting, peel-free. Free design, low minimums,
      express orders, nationwide delivery.
title: "{{title}}"
activeNavbar: true
...
seo:
  ...
  description: บริการรับสกรีนเสื้อยืด เสื้อทีม เสื้อกิจกรรม ด้วยระบบ DFT, Silk
    Screen,DTG และอื่นๆ สีสด ทนนาน ไม่หลุดลอก ออกแบบฟรี ขั้นต่ำน้อย
    งานด่วนสั่งได้ พร้อมจัดส่งทั่วประเทศ
เพิ่ม script ใน head:
  - type: application/ld+json
    content: '{"@context": "https://schema.org/",   "@type": "Product",    "name": "
      ...
      "รับสกรีนเสื้อทุกชนิด สกรีนด่วน สกรีนโลโก้คมชัด ราคาโรงงาน",   "brand":
      {     "@type": "Brand",     "name": "สมศรีมีเสื้อ"   },   "offers":
      {     "@type": "Offer",     "availability":
      "https://schema.org/InStock",     "priceCurrency": "THB",     "price":
      "20",     "itemOffered": {       "@type": "Service",       "name": "
      รับสกรีนเสื้อ"     }   },   "aggregateRating": {     "@type":
      "AggregateRating",     "ratingValue": "4.8",     "reviewCount": "389"   }}
      '
---
