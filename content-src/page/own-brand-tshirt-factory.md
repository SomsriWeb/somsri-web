...
i18n:
  title:
    th: รับผลิตเสื้อแบรนด์ตัวเอง ทำแบรนด์สกรีนเสื้อ คุณภาพดี ส่งไว
    en: Own-Brand T-Shirt Manufacturing — Brand Screen Printing, Great Quality, Fast
  description:
    th: สมศรีมีเสื้อ รับผลิตเสื้อแบรนด์ตัวเอง รับสร้างแบรนด์เสื้อผ้า
      รับทำเสื้อยืดแบรนด์ตัวเองคุณภาพเยี่ยม สั่งสกรีนเสื้อยืดราคาดี
      มีบริการส่งฟรี
    en: Somsri produces own-brand apparel and builds clothing brands — top-quality
      own-brand tees and great-value screen printing, with free delivery
      available.
title: "{{title}}"
description: "{{description}}"
lineLink: https://contact.somsritshirt.com/2076d
---
