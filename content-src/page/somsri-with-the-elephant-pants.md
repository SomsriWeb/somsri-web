...
i18n:
  title:
    th: รับผลิตกางเกงช้าง ออกแบบลายเองได้ โรงงานผลิตกางเกงช้าง ราคาถูกที่สุด
    en: Custom Elephant Pants — Design Your Own, Cheapest Elephant Pants Factory
  description:
    th: บริการรับผลิตกางเกงช้างครบวงจร ออกแบบลายใหม่ได้ เลือกเนื้อผ้าได้ตามต้องการ
      ผ้าไมโคร ผ้าไหมอิตาลี สั่งผลิตทำแบรนด์ตัวเองได้ ขั้นต่ำ 100 ตัว
    en: Full-service elephant-pants manufacturing — design new patterns and choose
      your fabric, from micro to Italian silk. Produce your own brand from a
      minimum of 100 pcs.
title: "{{title}}"
activeNavbar: true
...
seo:
  ...
  description: บริการรับผลิตกางเกงช้างครบวงจร ออกแบบลายใหม่ได้
    เลือกเนื้อผ้าได้ตามต้องการ ผ้าไมโคร ผ้าไหมอิตาลี สั่งผลิตทำแบรนด์ตัวเองได้
    ขั้นต่ำ 100 ตัว
เพิ่ม script ใน head:
  - type: application/ld+json
    content: '{"@context": "https://schema.org/",   "@type": "Product",    "name": "
      รับผลิตกางเกงช้าง",   "image":
      "https://somsritshirt.com/_ipx/f_webp/somsri-with-the-elephant-pants/pant-style-1.png",   "description":
      "บริการรับผลิตกางเกงช้างครบวงจร ออกแบบลายใหม่ได้
      เลือกเนื้อผ้าได้ตามต้องการ
      เหมาะสำหรับของที่ระลึกหรืองานอีเว้นท์",   "brand": {     "@type":
      "Brand",     "name": "สมศรีมีเสื้อ"   },   "offers": {     "@type":
      "Offer",     "availability":
      "https://schema.org/InStock",     "priceCurrency": "THB",     "price":
      "100",     "itemOffered": {       "@type": "Service",       "name": "
      กางเกงช้าง"     }   },   "aggregateRating": {     "@type":
      "AggregateRating",     "ratingValue": "4.8",     "reviewCount": "340"   }}
      '
---
