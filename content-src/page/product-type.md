...
i18n:
  title:
    th: สินค้าของสมศรีมีเสื้อ เสื้อยืด เสื้อโปโล เสื้อกีฬา และอื่นๆ
    en: Somsri Products — T-Shirts, Polos, Sportswear and More
  description:
    th: สินค้าของสมศรีมีเสื้อ
      สมศรีมีสินค้าพรีเมี่ยมหลากหลายชนิดไม่ว่าจะเป็นการสกรีนเสื้อ หน้ากาก
      กระเป๋าผ้า ผ้ากันเปื้อน และอื่น ๆ ให้คุณเลือกสรร
    en: Somsri’s products — a wide range of premium items including screen-printed
      shirts, face masks, cloth bags, aprons and more for you to choose from.
title: "{{title}}"
