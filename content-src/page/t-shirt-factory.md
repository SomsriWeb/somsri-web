...
i18n:
  title:
    th: รับผลิตเสื้อ สั่งทำเสื้อยืดสกรีน รับผลิตเสื้อโปโล สั่งผลิตเสื้อยืด
    en: Custom Shirts — Screen-Printed Tees, Polo Shirts & Made-to-Order T-Shirts
  description:
    th: รับผลิตเสื้อ สั่งทำเสื้อพร้อมสกรีน กับโรงงานผลิตเสื้อสมศรีมีเสื้อ
      เราผลิตจากเนื้อผ้าคุณภาพสูง ราคาโรงงาน งานไวคุณภาพดี การันตีผลงาน
    en: Custom shirts with screen printing from the Somsri garment factory. Made
      from high-quality fabric at factory prices — fast, great quality, results
      guaranteed.
title: "{{title}}"
