...
i18n:
  title:
    th: ออกแบบเสื้อ ด้วยตัวเอง เครื่องมือออนไลน์ดีไซน์เสื้อยืดฟรี
    en: Design Your Own Shirt — Free Online T-Shirt Design Tool
  description:
    th: ออกแบบเสื้อ ด้วยโปรแกรมออนไลน์ฟรี รับออกแบบและผลิต สกรีนเสื้อยืด เสื้อโปโล
      ปักเสื้อ สามารถเลือกสี ขนาด และสไตล์ของเสื้อยืดได้
    en: Design your own shirt with a free online tool, plus design and production
      services for screen-printed tees, polos and embroidery. Choose the color,
      size and style of your shirt.
title: "{{title}}"
