...
i18n:
  title:
    th: รับผลิตเสื้อวง เสื้อยืดวงดนตรี สั่งทำเสื้อทัวร์ [ดีที่สุดในปี 2024]
    en: Custom Band & Tour Shirts — Made-to-Order Music Tees
  description:
    th: สมศรีมีเสื้อ รับผลิตเสื้อวง เสื้อทัวร์ ตั้งแต่ออกแบบ ผลิต ด้วยคุณภาพดี
      ในราคาที่ย่อมเยาว์ เราคือโรงงานรับผลิตเสื้อวงที่มีเอกลักษณ์เฉพาะตัว
    en: Somsri produces band and tour shirts end to end, from design to
      manufacturing, at great quality and affordable prices. A band-shirt
      factory with a style all its own.
title: "{{title}}"
