...
<template>
    <div>
        <header>
            ...
            <div class="absolute bottom-[5rem] left-[5rem] text-white max-w-[35rem]">
            ...
            <ProseImg src="/tshirt-factory/tshirt.png" alt="สมศรีมีเสื้อ รับผลิตเสื้อ สั่งทำเสื้อครบวงจรในที่เดียว" class="absolute bottom-[5rem] right-[3rem]" />
        </header>
    </div>
</template>
