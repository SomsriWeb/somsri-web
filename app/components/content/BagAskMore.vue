        ...
        <div class="bg-primary w-full max-w-2xl sm:max-w-3xl md:max-w-4xl p-6 sm:p-8 rounded-2xl mx-auto">
            ...
            <div class="flex justify-center items-center gap-2 pt-2 lg:gap-5 sm:gap-5 md:gap-5">
                <nuxt-link to="https://www.facebook.com/somsritshirt/" target="_blank" aria-label="Facebook">
                    <NuxtImg src="/bag/fb-240w.png" class="w-5 sm:w-8 object-contain" alt="Facebook" />
                </nuxt-link>

                <nuxt-link to="https://contact.somsritshirt.com/3d8f7" target="_blank" aria-label="LINE">
                    <NuxtImg src="/bag/line-2-unsmushed.png" class="w-5 sm:w-8 object-contain" alt="LINE" />
                </nuxt-link>

                <nuxt-link to="https://www.instagram.com/somsritshirt/" target="_blank" aria-label="Instagram">
