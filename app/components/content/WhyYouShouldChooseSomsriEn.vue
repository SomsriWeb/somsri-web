<script setup lang="ts">
	import MinimumModal from "../WhyYouShouldChooseSomsriEn/Minimum.vue"
	import PerfectDesignModal from "../WhyYouShouldChooseSomsriEn/PerfectDesign.vue"
	import GuaranteeModal from "../WhyYouShouldChooseSomsriEn/Guarantee.vue"
	import FreeShippingModal from "../WhyYouShouldChooseSomsriEn/FreeShipping.vue"
	...
	const { data: content } = await useAsyncData("why-you-should-choose-somsri-en", () =>
		queryCollection("whyYouShouldChooseSomsriEn").order("order", "ASC").all()
	)
