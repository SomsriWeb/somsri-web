...
interface Slots {
    ...
    strategyimage2(): unknown;
    strategyList2(): unknown;
    strategyimage3(): unknown;
    strategyList3(): unknown;
    strategyimage4(): unknown;
    strategyList4(): unknown;
}
defineSlots<Slots>();
</script>
<template>
    <section class="grid grid-cols-2 gap-4 text-sm sm:grid-cols-2 lg:grid-cols-4" role="list" aria-label="กลยุทธ์และจุดเด่น">
