...
<template>
    <div class="px-0 md:px-0">
        <div
            class="relative w-full flex items-center justify-center text-center px-3 sm:px-6 md:px-12 py-4 sm:py-6 md:py-10 overflow-hidden rounded-xl aspect-[12/5] md:aspect-[5/2]"
        >
            <NuxtPicture
                :src="image"
                :alt="alt"
