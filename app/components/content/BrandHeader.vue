<template>
	<div class="relative overflow-x-hidden">
		<header class="relative w-full h-screen overflow-hidden">
			...
			<div
				class="absolute inset-0 grid grid-cols-1 lg:grid-cols-2 items-center justify-center px-4 sm:px-8 lg:px-20 pt-4 pb-4 overflow-auto max-h-screen text-white"
			>
				<!-- ฝั่ง Image -->
				<div
				...
				<div class="order-2 lg:order-1 text-center lg:text-left max-w-full z-10">
					<ProseH1
						class="!text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold leading-tight break-words"
					>
