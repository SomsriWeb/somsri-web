...
<template>
	<div>
		<div
			class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 place-items-center"
		>
			<div
			...
			>
				...
				<div class="w-full aspect-square rounded-2xl overflow-hidden shadow-md">
					<ProseImg :src="item.image" :alt="item.name" class="object-cover" />
				</div>
