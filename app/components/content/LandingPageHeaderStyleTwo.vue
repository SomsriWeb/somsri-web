...
interface Props {
    ...
    alt?: string;
    imageAnchor?: 'left' | 'center' | 'right' | string;
}
const { image, titleAsTag = 'h1', alt = '', imageAnchor = 'center' } = defineProps<Props>();
...
<template>
    <header class="relative">
        <ProseImg :src="image" :alt="alt" class="w-screen! h-screen! object-cover" :class="{ [objectPosition]: true }" />
