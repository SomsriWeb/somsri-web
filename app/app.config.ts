        ...
        button: {
            ...
            compoundVariants: [
                ...
                },
                {
                    color: 'primary',
                    variant: 'outline',
                    class: 'ring-2 ring-inset ring-primary text-primary hover:bg-primary/10 disabled:bg-transparent aria-disabled:bg-transparent dark:disabled:bg-transparent dark:aria-disabled:bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-primary',
                },
                {
                    color: 'primary',
                    variant: 'soft',
                ...
                },
                {
                    color: 'line',
                    variant: 'outline',
                    class: 'ring-2 ring-inset ring-line text-line hover:bg-line/10 disabled:bg-transparent aria-disabled:bg-transparent dark:disabled:bg-transparent dark:aria-disabled:bg-transparent focus:outline-none focus-visible:ring-2 focus-visible:ring-line',
                },
                {
                    color: 'line',
                    variant: 'soft',
