...
export default defineContentConfig({
    collections: {
        // Generated by scripts/i18n-generate.ts (content/{th,en}/page/**).
        // The `prefix` strips the `<locale>/page` base so URLs line up with
        // @nuxtjs/i18n strategy "prefix_except_default": th → /about, en → /en/about.
        contentTh: defineCollection({
            type: 'page',
            source: {
                include: 'th/page/**',
                prefix: '/',
